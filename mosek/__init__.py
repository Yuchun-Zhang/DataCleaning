...
import platform
try:
    __libname = __makelibname('mosekxx7_0')
    __libsupport = []
...
dataformat = Enum("dataformat", ["extension","free_mps","lp","mps","op","task","xml"], [0,5,2,1,3,6,4])
...
class Task:
  ...
  def appendbarvars(self,dim_):
    ...
    appendbarvars(self,dim_)
      dim: array of int. Dimmension of symmetric matrix variables to be added.
    """
    num_ = None
    if num_ is None:
      num_ = len(dim_)
  ...
  def appendconesseq(self,conetype_,conepar_,nummem_,j_):
    """
    Appends a mulriple conic constraints to the problem.
  ...
  def getbarvarnameindex(self,somename_):
    ...
    returns: asgn,index
      ...
      index: int. If the name somename is assinged to a semidefinite variable, then index is the name of the constraint.
    """
  ...
  def getconnameindex(self,somename_):
    """
    Checks whether the name somename has been assimed to any constraint.
    ...
    returns: asgn,index
      ...
      index: int. If the name somename is assinged to a constraint, then index is the name of the constraint.
    """
    if isinstance(somename_,unicode):
      somename_ = somename_.encode("utf-8")
    asgn_ = ctypes.c_int32()
  ...
  def getvarnameindex(self,somename_):
    """
    Checks whether the name somename has been assimed to any variable.
  
    getvarnameindex(self,somename_)
      somename: str|unicode. The name which should be checked.
    returns: asgn,index
      asgn: int. Is non-zero if name somename is assigned to a variable.
      index: int. If the name somename is assinged to a variable, then index is the name of the variable.
    """
    if isinstance(somename_,unicode):
      somename_ = somename_.encode("utf-8")
    asgn_ = ctypes.c_int32()
  ...
  def getconenameindex(self,somename_):
    """
    Checks whether the name somename has been assimed to any cone.
  
    getconenameindex(self,somename_)
      somename: str|unicode. The name which should be checked.
    returns: asgn,index
      asgn: int. Is non-zero if name somename is assigned to a cone.
      index: int. If the name somename is assinged to a cone, then index is the name of the cone.
    """
    if isinstance(somename_,unicode):
      somename_ = somename_.encode("utf-8")
    asgn_ = ctypes.c_int32()
  ...
  def getdimbarvarj(self,j_):
    """
    Obtains the dimension of a symmetrix matrix variable.
  ...
  def getsux(self,whichsol_,sux_):
    ...
    if _sux_copyarray:
      if isinstance(sux_, numpy.ndarray) and False:
        ...
        sux_[:] = _sux_tmp
  @accepts(_accept_any,_accept_anyenum(soltype),_accept_doublevector)
  def getsnx(self,whichsol_,sux_):
    """
    Obtains the snx vector for a solution.
  
    getsnx(self,whichsol_,sux_)
      whichsol: mosek.soltype. Selects a solution.
    ...
    if isinstance(sux_, numpy.ndarray) and sux_.dtype is numpy.float64 and sux_.flags.contiguous:
      ...
      _sux_copyarray = True
      _sux_tmp = (ctypes.c_double * len(sux_))(*sux_)
    res = __library__.MSK_XX_getsnx(self.__nativep,whichsol_,_sux_tmp)
    if res != 0:
      _,msg = self.__getlasterror(res)
      raise Error(rescode(res),msg)
    if _sux_copyarray:
  ...
  def getpviolcon(self,whichsol_,sub_,viol_):
    ...
    getpviolcon(self,whichsol_,sub_,viol_)
      ...
      viol: array of double. List of violations correspondig to sub.
    """
    num_ = None
    if num_ is None:
      num_ = len(sub_)
  ...
  def getpviolcones(self,whichsol_,sub_,viol_):
    """
    Computes the violation of a solition for set of conic constraints.
  ...
  def getsolutioninfo(self,whichsol_):
    ...
    getsolutioninfo(self,whichsol_)
      whichsol: mosek.soltype. Selects a solution.
    returns: pobj,pviolcon,pviolvar,pviolbarvar,pviolcone,pviolitg,dobj,dviolcon,dviolvar,dviolbarvar,dviolcones
      ...
      pviolcone: double. Maximal primal violation of the solution with respct to the conic constraints.
      ...
      dviolcones: double. Maximum violation of the dual solution in the dual conic constraints .
    """
    ...
    _dviolcones_return_value = dviolcones_.value
    return (_pobj_return_value,_pviolcon_return_value,_pviolvar_return_value,_pviolbarvar_return_value,_pviolcone_return_value,_pviolitg_return_value,_dobj_return_value,_dviolcon_return_value,_dviolvar_return_value,_dviolbarvar_return_value,_dviolcones_return_value)
  ...
  def primalrepair(self,wlc_,wuc_,wlx_,wux_):
    ...
    primalrepair(self,wlc_,wuc_,wlx_,wux_)
      ...
      wuc: array of double. Weights associated with relaxaing the upper bound on the constraints.
      wlx: array of double. Weights associated with relaxaing the lower bounds of the variables.
      wux: array of double. Weights associated with relaxaing the upper bounds of variables.
    """
    if wlc_ is not None and len(wlc_) < self.getnumcon():
      raise ValueError("Array argument wlc is not long enough")
    if isinstance(wlc_, numpy.ndarray) and wlc_.dtype is numpy.float64 and wlc_.flags.contiguous:
  ...
  def getbarcidxinfo(self,idx_):
    """
    Obtains infromation about an element in barc.
  ...
  def getbaraidxinfo(self,idx_):
    ...
    returns: num
      num: long. Number of terms in the weighted sum that forms the specfied element in barA.
    """
    num_ = ctypes.c_int64()
    num_ = ctypes.c_int64()
  ...
  def getbaraidx(self,idx_,sub_,weights_):
    ...
    getbaraidx(self,idx_,sub_,weights_)
      idx: long. Position of the element in the vectorized form.
      sub: array of long. A list indicies of the elements from symmetric matrix storage that appers in the weighted sum.
  ...
  def getbarcblocktriplet(self,subj_,subk_,subl_,valijkl_):
    ...
    getbarcblocktriplet(self,subj_,subk_,subl_,valijkl_)
      ...
      valijkl: array of double. A list indicies of the elements from symmetric matrix storage that appers in the weighted sum.
    returns: num
  ...
  def appendsparsesymmat(self,dim_,subi_,subj_,valij_):
    """
    Appends a general sparse symmetric matrix to the vector E of symmetric matricies.
  
    appendsparsesymmat(self,dim_,subi_,subj_,valij_)
      dim: int. Dimmension of the symmetric matrix that is appended.
  ...
  def getnumsymmat(self):
    """
    Get the number of symmetric matricies stored.
  
    getnumsymmat(self)
    returns: num
      num: long. Returns the number of symmetric sparse matricies.
    """
    num_ = ctypes.c_int64()
    num_ = ctypes.c_int64()
  ...
  def getsparsesymmat(self,idx_,subi_,subj_,valij_):
    """
    Gets a single symmetrix matrix from the matrix store.
  ...
  def putmaxnumbarvar(self,maxnumbarvar_):
    """
    Sets the number of preallocated symmetrix matrix variables in the optimization task.
  ...
  def onesolutionsummary(self,whichstream_,whichsol_):
    """
    Prints a short summary for the specfied solution.
